      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3">
            <h4 className="text-blue-100 dark:text-blue-600 text-sm font-medium mb-2">Form Status</h4>
            <div className="text-xs text-blue-100 dark:text-blue-600 space-y-1">
...
export default function MappingCCBenefitPage() {
  ...
  return (
    <AdminLayout 
      title="CC Benefit Mapping" 
      subtitle={`Database: n8n_mapping_sme_cb_cc_benefit (${filteredData.length} records)`}
    >
