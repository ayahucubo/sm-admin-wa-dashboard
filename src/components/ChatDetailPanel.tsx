      ...
      <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 p-3 sm:p-4 lg:p-6 flex-shrink-0">
        <div className="flex flex-col sm:flex-row items-start sm:items-end gap-3 sm:gap-4">
          ...
          <button
            ...
            className="btn-secondary px-3 sm:px-4 py-2 w-full sm:w-auto text-sm sm:text-base"
          >
            Reset
          </button>
        </div>
      ...
      <div className="flex-1 scrollable-content p-3 sm:p-4 lg:p-6">
        {loading ? (
          ...
          <div className="text-center py-8 sm:py-12">
            ...
            <h3 className="text-base sm:text-lg font-semibold text-primary mb-2">Tidak ada riwayat</h3>
            <p className="text-muted text-sm sm:text-base">Belum ada percakapan untuk ditampilkan</p>
          </div>
        ) : (
